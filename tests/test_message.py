...
class MessageTest(TestCase):
    def test_email_date_converter(self):
        ...
        self.assertEqual(
            ...
            datetime.strptime(
                "Mon, 24 Jan 2022 08:32:02 +0000", "%a, %d %b %Y %H:%M:%S %z"
            ),
        )
        self.assertEqual(
        ...
        self.assertEqual(
            ...
            datetime.strptime(
                "Tue, 25 Jan 2022 09:45:12 +0100", "%a, %d %b %Y %H:%M:%S %z"
            ),
        )
        self.assertEqual(
            email_date_converter("Wed, 26 Jan 2022 10:58:22 +0200 (EET)"),
            datetime.strptime(
                "Wed, 26 Jan 2022 10:58:22 +0200", "%a, %d %b %Y %H:%M:%S %z"
            ),
        )
        self.assertEqual(
            email_date_converter("Thu, 27 Jan 2022 11:12:32 +0300 (MSK)"),
            datetime.strptime(
                "Thu, 27 Jan 2022 11:12:32 +0300", "%a, %d %b %Y %H:%M:%S %z"
            ),
        )
        self.assertEqual(
