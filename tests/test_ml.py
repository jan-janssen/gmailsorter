...
class TestMlEncoding(unittest.TestCase):
    ...
    def test_encode_df_for_machine_learning_no_feature_list(self):
        df_features = encode_df_for_machine_learning(self.df, return_labels=False, label_prefix="labels_Label_")
    ...
    def test_encode_df_for_machine_learning_with_feature_list(self):
        ...
        df_features = encode_df_for_machine_learning(
            self.df, feature_lst=features, return_labels=False, label_prefix="labels_Label_",
        )
        self.assertEqual(
    ...
    def test_encode_df_for_machine_learning_with_numpy_arrays(self):
        ...
        df_features, df_labels = encode_df_for_machine_learning(
            self.df, feature_lst=features, label_lst=labels, return_labels=True, label_prefix="labels_Label_",
        )
        self.assertEqual(
            set(df_features.columns),
            {"cc_@test.com", "from_from1@test.com", "email_id"},
...
"""
        ...
        df_features, df_labels = encode_df_for_machine_learning(df, return_labels=True, label_prefix="labels_Label_")
