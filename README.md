...
* [Troubleshooting](https://gmailsorter.readthedocs.io/en/latest/troubleshooting.html)
  * [Email sorting is stuck or shows an error](https://gmailsorter.readthedocs.io/en/latest/troubleshooting.html#email-sorting-is-stuck-or-shows-an-error)
  * [Token has been expired or revoked](https://gmailsorter.readthedocs.io/en/latest/troubleshooting.html#token-has-been-expired-or-revoked-insufficient-permission)
